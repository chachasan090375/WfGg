...
def main()->int:
    ...
    o.add_argument("--deployment-id",required=True);o.add_argument("--state",type=Path,required=True);o.add_argument("--anomaly",type=Path);o.add_argument("--lineage",type=Path);o.add_argument("--evaluation",type=Path)
    ...
    if a.cmd=="observe":
        ...
        evaluation=load(a.evaluation) if a.evaluation else None
