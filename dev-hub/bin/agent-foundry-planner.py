...
def decide_package(pkg:dict[str,Any],routing:dict[str,Any],cfg:dict[str,Any],project_id:str,
    ...
    manifest={
        ...
        "governance_class":"FULL_AGENT" if decision=="CREATE_REUSABLE_AGENT_CANDIDATE" else "LIGHTWEIGHT_PROJECT_AGENT",
        "owner_foundry":"agent-foundry",
        "health_contract":"CLASS_DEFAULT_HEALTH",
        "observability":"CANONICAL_REGISTRY_AND_OBSERVATION_BUS",
        "retention_policy":"CLASS_DEFAULT_RETENTION",
        "purge_policy":"UNIVERSAL_HYGIENE",
        "rollback_policy":"ROLLBACK_REQUIRED_WHEN_MATERIAL",
        "canonical_registration_required":True,
        "materialization_gate_required":True,
        "birth_contract":{"schema":"chacha.dev/component-birth-contract/v1",
          "status":"PENDING_CANONICAL_REGISTRATION","owner_foundry":"agent-foundry",
