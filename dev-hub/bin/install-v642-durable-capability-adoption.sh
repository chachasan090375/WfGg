...
for marker in   CHACHA_DEV_V642_VERIFIED_SUCCESS_BEFORE_ADOPTION=PASS   CHACHA_DEV_V642_PROJECT_CONTROL_COMMITTED_PROOF=PASS   CHACHA_DEV_V642_SUCCESS_CLAIMS_BOUND_TO_VERIFIED_RESULT=PASS   CHACHA_DEV_V642_RELEASE_INDEPENDENT_DURABLE_REGISTRY=PASS   CHACHA_DEV_V642_CROSS_PROJECT_REUSE_WITHOUT_REBUILD=PASS   CHACHA_DEV_V642_IDEMPOTENT_ADOPTION=PASS   CHACHA_DEV_V642_PROTECTED_ADOPTION_HUMAN_BOUNDARY=PASS; do
