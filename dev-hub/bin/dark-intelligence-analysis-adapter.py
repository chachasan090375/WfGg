...
MODEL_SPEC=(os.environ.get("CHACHA_DEV_DARK_INTEL_MODELS") or os.environ.get("CHACHA_DEV_DARK_INTEL_MODEL") or "gemini-3.6-flash-medium,gemini-3.8-flash-medium,gemini-3.7-flash-medium,gemini-3.7-flash-low,gemini-3.8-flash-low,gemini-3.6-flash-low")
