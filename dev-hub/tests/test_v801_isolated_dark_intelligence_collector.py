...
assert ("OnUnitActiveSec=15min" in timer) or ("OnActiveSec=1min" in timer and "OnUnitInactiveSec=15min" in timer)
...
assert ("OnUnitActiveSec=15min" in corroboration_retry_timer) or ("OnActiveSec=1min" in corroboration_retry_timer and "OnUnitInactiveSec=15min" in corroboration_retry_timer)
