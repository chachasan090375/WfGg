CREATE TABLE IF NOT EXISTS external_final_reviews (
...
CREATE INDEX IF NOT EXISTS idx_external_final_reviews_identity
  ON external_final_reviews(project_id,revision,compromise_digest,source);
