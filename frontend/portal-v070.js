...
function renderSettingsContent(){const c=$('settingsContent');if(state.settingsTab==='profile')c.innerHTML=profileSettingsHtml();else if(state.settingsTab==='alliance'&&isAdmin())c.innerHTML=allianceSettingsHtml();else if(state.settingsTab==='application'&&isAdmin())c.innerHTML=applicationSettingsHtml();else if(state.settingsTab==='rights'&&isAdmin())c.innerHTML=rightsHtml();else{state.settingsTab='profile';c.innerHTML=profileSettingsHtml()}bindSettingsForms();}
