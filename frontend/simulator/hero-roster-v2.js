(() => {
  ...
  function tabFields(cat,d,owned){
    ...
    return `<div class="hero-game-stats">${number('displayedPower',t('power'))}${number('displayedAttack',t('attack'))}${number('displayedDefense',t('defense'))}${number('displayedHp',t('hp'))}${number('level',t('level'),1,200)}${number('stars',t('stars'),0,5,'0.1')}</div>`;
  }
