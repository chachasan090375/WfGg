...
case "$LAST" in
  ...
  *nativeStage=LOGIN_INIT_PULL_SENT*) echo SERVER_EXPLORER_SENTINEL_VERDICT=LOGIN_INIT_SENT_WAITING_INIT ;;
  *nativeStage=LOGIN_INIT_PULL_WRITE_FAILED*) echo SERVER_EXPLORER_SENTINEL_VERDICT=LOGIN_INIT_WRITE_FAILED ;;
