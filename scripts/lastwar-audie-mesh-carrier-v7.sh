...
import UnityPy
PYCHK
PYTHONUNBUFFERED=1 python "$ROOT/scripts/lastwar-audie-mesh-carrier-v7.py" "$ROOT"
echo "VIEWER=http://127.0.0.1:8788/lab/lastwar-audie-mesh-carrier-viewer.html?v=7"
