...
echo "OMNITRACE_DIFF_V3_START action=$ACTION baseline=$BASELINE"
PYTHONUNBUFFERED=1 python3 -u "$ROOT/scripts/lastwar-formation-omnitrace-differential-v3.py" "$SESS/$ACTION" "$SESS/$BASELINE" "$OUT"
...
echo 'VIEWER=http://127.0.0.1:8788/lab/lastwar-formation-omnitrace-differential.html?v=3'
