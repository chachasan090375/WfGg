...
python3 "$ROOT/scripts/lastwar-formation-omnitrace-differential-v1.py" "$SESS/$ACTION" "$SESS/$BASELINE" "$OUT"
...
echo 'VIEWER=http://127.0.0.1:8788/lab/lastwar-formation-omnitrace-differential.html?v=1'
