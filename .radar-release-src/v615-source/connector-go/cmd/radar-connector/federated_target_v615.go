...
// WFGG_RADAR_TARGETED_FEDERATED_SERVER_V615
func federatedServerTargetV615(query string) (string, bool) {
...
func scanCollectorRegionTargetV615(ctx context.Context, game protocol.Client, fallback protocol.RegionScanner, token string, region int, query string) ([]protocol.Player, protocol.RegionScanDiagnostic, error) {
	target, targeted := federatedServerTargetV615(query)
	if !targeted {
