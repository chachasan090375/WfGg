...
func ValidatePrivate(d Draft) error {
...
func BuildPrivateDryRun(d Draft) (DryRun, error) {
	...
	return DryRun{
		...
		Fields: []WireField{
			{Method: "PutUtfString", Key: "name", Value: strings.TrimSpace(d.TargetName)},
			...
			{Method: "PutUtfString", Key: "targetUid", Value: strings.TrimSpace(d.TargetUID)},
